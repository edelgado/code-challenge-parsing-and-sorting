# Code Challenge - Parsing information and outputting in certain ways.
...
* Besides the testing framework RSpec, only Ruby and its standard library were used (no other gems).
* Used Ruby MRI 2.3.1
